...
void LRT_CD_DisDate(unsigned int month,unsigned int day)        //display day
{
    unsigned long i;
    unsigned long d;
    int segtmp;
...
void RT_LCD_DisSign(unsigned long x, unsigned long y)        //display special sign
{
...
void RT_LCD_ClearSign(unsigned long x,unsigned long y)        //clear special sign
{
    unsigned long c=0x00000001,d;
    d=MemoryRead32(LCD_RAM_REG+x);
    d=d&~(c<<y);
...
void RT_LCD_BlinkSign(unsigned long x,unsigned long y)        //blink special sign
{
    unsigned long c=0x00000001,d;
    int a;
