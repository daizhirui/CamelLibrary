...
void LCD_ShowAll();
void LCD_DispOn();
void LCD_DisHiPressure(unsigned int b);
void LCD_DisLoPressure(unsigned int b);
void LCD_DisHeartRate(unsigned int b);
void LCD_DisDate(unsigned int month,unsigned int day);
void LCD_DisTime(unsigned int hour,unsigned int minute);
void LCD_DisSign(unsigned int x,unsigned int y);
void LCD_ClearSign(unsigned int x,unsigned int y);
void LCD_GetSegCode1(unsigned int b);
void LCD_GetSegCode2(unsigned int b);
void LCD_GetSegCode3(unsigned int b);
void LCD_ExtractDigit(unsigned int b);
void LCD_BlinkSign(unsigned int x,unsigned int y);
