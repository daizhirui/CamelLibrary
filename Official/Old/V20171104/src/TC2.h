...
#define TC2_Stop() MemoryWrite32(T2_CTL0_REG, 0)
#define TC2_ClearIrq() MemoryWrite32(T2_CLRIRQ_REG, 0)
#define TC2_ClearCnt() MemoryWrite32(T2_CLRCNT_REG, 0)
#define TC2_ClearAll()                   \
    {                                    \
        MemoryWrite32(T2_CLRIRQ_REG, 0); \
        MemoryWrite32(T2_CLRCNT_REG, 0); \
    }
#define TC2_TcIrqOn() MemoryOr32(T2_CTL0_REG, 1 << 7)
#define TC2_TcIrqOff() MemoryAnd32(T2_CTL0_REG, ~(1 << 7))
#define TC2_PWM0IrqOn() MemoryOr32(T2_CTL0_REG, 1 << 6)
#define TC2_PWM0IrqOff() MemoryAnd32(T2_CTL0_REG, ~(1 << 6))
#define TC2_CheckTcFlag() ((MemoryRead32(T2_CTL0_REG) & 0x80000000) >> 31)
#define TC2_CheckPWM0Flag() ((MemoryRead32(T2_CTL0_REG) & 0x40000000) >> 30)
/****************** end*******************/

/****************** Timer ******************/
#define TC2_TimerOn() MemoryOr32(T2_CTL0_REG, 1 << 1)
#define TC2_TimerOff() MemoryAnd32(T2_CTL0_REG, ~(1 << 1))
/**
 * @brief 
...
/****************** ECNT *******************/
#define TC2_EcntOn() MemoryOr32(T2_CTL0_REG, 1)
#define TC2_EcntOff() MemoryAnd32(T2_CTL0_REG, ~1)
/**
 * @brief 
 ...
 * @return          void
 */
#define TC2_SetEcnt(n, trigger, irq)                                  \
    {                                                                 \
...
/****************** PWM *******************/
#define TC2_PWM0On() MemoryOr32(T2_CTL0_REG, 1 << 4)
#define TC2_PWM0Off() MemoryAnd32(T2_CTL0_REG, ~(1 << 4))
#define TC2_PWM1to3On() MemoryOr32(T2_CTL0_REG, 1 << 5)
#define TC2_PWM1to3Off() MemoryAnd32(T2_CTL0_REG, ~(1 << 5))
/**
 * @brief 
 ...
 * @return          void
 */
#define TC2_SetAllPWM(div, duty0, duty1, duty2, duty3, phase0, phase1, phase2, phase3, pwm0, pwm13) \
    {                                                                                               \
...
/*********** Timer2 PWMM Setup*************/
#define TC2_PWMMOn() MemoryOr32(T2_CTL0_REG, 1 << 3)
#define TC2_PWMMOff() MemoryAnd32(T2_CTL0_REG, ~(1 << 3))
#define TC2_PWMMTriggerMode(mode)            \
    {                                        \
 ...
 * @return          void 
 */
#define TC2_SetPWMM(trigger, irq)                                   \
    {                                                               \
        MemoryAnd32(T2_CTL0_REG, ~((0x1 << 7) + (0x1 << 2)));       \
...
/*************** Timer2 Read ***************/
#define TC2_ReadCnt() MemoryRead32(T2_READ_REG)
