...
#define TC4_AllPWM_On() MemoryWrite32(T4_CTL0_REG, 3)
#define TC4_AllPWM_Off() MemoryWrite32(T4_CTL0_REG, 0)
#define TC4_PWM_On(n) MemoryOr32(T4_CLK0_REG, 1 << n)
#define TC4_PWM_Off(n) MemoryAnd32(T4_CTL0_REG, ~(1 << n))
/****************** end*******************/
 ...
 * @return          void
 */
#define TC4_SetAllPWM(pwm0_en, div0, ref0, pwm1_en, div1, ref1) \
    {                                                           \
 ...
 * @return          void
 */
#define TC4_SetPWM(n, pwm_en, div, ref)          \
    {                                            \
