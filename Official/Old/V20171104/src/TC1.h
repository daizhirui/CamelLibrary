...
#define TC1_Stop() MemoryWrite32(T1_CTL0_REG, 0)
#define TC1_ClearIrq() MemoryWrite32(T1_CLRIRQ_REG, 0)
#define TC1_ClearCnt() MemoryWrite32(T1_CLRCNT_REG, 0)
#define TC1_ClearAll()  \
    {                   \
        TC1_ClearIrq(); \
        TC1_ClearCnt(); \
    }
#define TC1_TcIrqOn() MemoryOr32(T1_CTL0_REG, 1 << 7)
#define TC1_TcIrqOff() MemoryAnd32(T1_CTL0_REG, ~(1 << 7))
#define TC1_PWMIrqOn() MemoryOr32(T1_CTL0_REG, 1 << 6)
#define TC1_PWMIrqOff() MemoryAnd32(T1_CTL0_REG, ~(1 << 6))
#define TC1_CheckTcFlag() ((MemoryRead32(T1_CTL0_REG) & 0x80000000) >> 31)
#define TC1_CheckPWMFlag() ((MemoryRead32(T1_CTL0_REG) & 0x40000000) >> 30)
/****************** end*******************/
/****************** Timer ******************/
#define TC1_TimerOn() MemoryOr32(T1_CTL0_REG, 1 << 1)
#define TC1_TimerOff() MemoryAnd32(T1_CTL0_REG, ~(1 << 1))
/**
 * @brief 
...
/****************** ECNT *******************/
#define TC1_EcntOn() MemoryOr32(T1_CTL0_REG, 1)
#define TC1_EcntOff() MemoryAnd32(T1_CTL0_REG, ~1)
/**
 * @brief 
 ...
 * @return          void
 */
#define TC1_SetEcnt(n, trigger, irq)                                  \
    {                                                                 \
...
/****************** PWM *******************/
#define TC1_PWMOn() MemoryOr32(T1_CTL0_REG, 1 << 4)
#define TC1_PWMOff() MemoryAnd32(T1_CTL0_REG, ~(1 << 4))
/**
 * @brief 
...
/****************** PWMM ******************/
#define TC1_PWMMOn() MemoryOr32(T1_CTL0_REG, 1 << 3)
#define TC1_PWMMOff() MemoryAnd32(T1_CTL0_REG, ~(1 << 3))
#define TC1_PWMMTriggerMode(mode)            \
    {                                        \
 ...
 * @return          void 
 */
#define TC1_SetPWMM(trigger, irq)                                   \
    {                                                               \
        MemoryAnd32(T1_CTL0_REG, ~((0x1 << 7) + (0x1 << 2)));       \
...
/*************** Timer0 Read ***************/
#define TC1_ReadCnt() MemoryRead32(T1_READ_REG)
