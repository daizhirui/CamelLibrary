 ...
 * @return      void
 */
#define IO_SetOutput(A) MemoryOr32(SYS_IOCTL_REG, (1 << A))
/**
 * @brief This function sets a specific channel at INPUT mode
 * 
 * @return      void
 */
#define IO_SetInput(A) MemoryAnd32(SYS_IOCTL_REG, ~(1 << A))
/**
 ...
 * @return      void
 */
#define IO_Mode16(A) MemoryWrite32(SYS_IOCTL_REG, A)
/**
 * @brief This function sets a specific output io channel at HIGH level
 * 
 * @return      void 
 */
#define IO_SetHigh(A) MemoryOr32(SYS_GPIO0_REG, (1 << A))
/**
 * @brief This function sets a specific output io channel at LOW level
 * 
 * @return      void 
 */
#define IO_SetLow(A) MemoryAnd32(SYS_GPIO0_REG, ~(1 << A))
/**
 ...
 * @return      void 
 */
#define IO_Write16(A) MemoryWrite32(SYS_GPIO0_REG, A)
/**
