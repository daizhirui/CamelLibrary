 ...
 * @return      void
 */
#define RTC_On() MemoryOr32(RTC_CTL_REG, 1)
/**
 * @brief This function turns RTC off
 * 
 * @return      void
 */
#define RTC_Off() MemoryAnd32(RTC_CTL_REG, ~1)
/**
 ...
 * @return      void
 */
#define RTC_SetTimeFormat(format)                \
    {                                            \
 ...
 * @return          void
 */
#define RTC_SetTime(year, month, day, hour, min, sec) \
 ...
 * @return #define 
 */
#define RTC_Read32()    MemoryRead32(RTC_TIME_REG)
/**
 ...
 * @param d_sec     second
 */
extern void RTC_GetTime(unsigned char *d_year, unsigned char *d_mon, unsigned char *d_day,
 ...
 */
void delayMiliseconds(unsigned long ms);
