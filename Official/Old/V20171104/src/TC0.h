...
#define TC0_Stop() MemoryWrite32(T0_CTL0_REG, 0)
#define TC0_ClearIrq() MemoryWrite32(T0_CLRIRQ_REG, 0)
#define TC0_ClearCnt() MemoryWrite32(T0_CLRCNT_REG, 0)
#define TC0_ClearAll()  \
    {                   \
        TC0_ClearIrq(); \
        TC0_ClearCnt(); \
    }
#define TC0_TcIrqOn() MemoryOr32(T0_CTL0_REG, 1 << 7)
#define TC0_TcIrqOff() MemoryAnd32(T0_CTL0_REG, ~(1 << 7))
#define TC0_PWMIrqOn() MemoryOr32(T0_CTL0_REG, 1 << 6)
#define TC0_PWMIrqOff() MemoryAnd32(T0_CTL0_REG, ~(1 << 6))
#define TC0_CheckTcFlag() ((MemoryRead32(T0_CTL0_REG) & 0x80000000) >> 31)
#define TC0_CheckPWMFlag() ((MemoryRead32(T0_CTL0_REG) & 0x40000000) >> 30)
/****************** end*******************/
...
/****************** ECNT *******************/
#define TC0_EcntOn() MemoryOr32(T0_CTL0_REG, 1)
#define TC0_EcntOff() MemoryAnd32(T0_CTL0_REG, ~1)
/**
 * @brief 
 ...
 * @return          void
 */
#define TC0_SetEcnt(n, trigger, irq)                                  \
    {                                                                 \
...
/****************** PWM *******************/
#define TC0_PWMOn() MemoryOr32(T0_CTL0_REG, 1 << 4)
#define TC0_PWMOff() MemoryAnd32(T0_CTL0_REG, ~(1 << 4))
/**
 * @brief 
...
/****************** PWMM ******************/
#define TC0_PWMMOn() MemoryOr32(T0_CTL0_REG, 1 << 3)
#define TC0_PWMMOff() MemoryAnd32(T0_CTL0_REG, ~(1 << 3))
#define TC0_PWMMTriggerMode(mode)            \
    {                                        \
 ...
 * @return          void 
 */
#define TC0_SetPWMM(trigger, irq)                                   \
    {                                                               \
        MemoryAnd32(T0_CTL0_REG, ~((0x1 << 7) + (0x1 << 2)));       \
...
/*************** Timer0 Read ***************/
#define TC0_ReadCnt() MemoryRead32(T0_READ_REG)
