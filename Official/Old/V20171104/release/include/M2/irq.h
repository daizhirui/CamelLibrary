 ...
 * @return          void
 */
#define EXINT_Off(port) MemoryAnd32(INT_CTL0_REG, ~(1 << port))
/**
 * @brief This function clears interrupt flag from specific EXINT port
 * 
 * @return          void
 */
#define EXINT_Clear(no) MemoryWrite(INT_CLR_REG, 1 << no)
/**
 * @brief This function clears all EXINT flag
 * 
 * @return          void
 */
#define EXINT_ClearAll() MemoryWrite(INT_CLR_REG, 0xff)
/**
 * @brief This function gets the EXINT flag table
 * 
 * @return         the EXINT flag table 
 */
#define EXINT_GetFlag() MemoryRead(INT_CTL1_REG)
