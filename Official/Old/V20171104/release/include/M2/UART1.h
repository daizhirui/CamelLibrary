...
/*************** UART1 Setup***************/
#define UART1_Off()             MemoryOr32(UART1_CTL,0x10)                  // UART1 off
#define UART1_On()              {SPI_Off();MemoryAnd32(UART1_CTL,~0x10);}   // UART1 on
#define UART1_Busy()            MemoryRead32(UART1_BUSY)                    // check tx busy
#define UART1_Write(val)        MemoryWrite32(UART1_WRITE,val)              // send the data
#define UART1_DataReady()       MemoryRead32(UART1_DATA_RDY)                // check data ready
#define UART1_Read()            MemoryRead32(UART1_READ)                    // read the data
/**
 * @brief This function sets UART1 compare irq on
 * 
 * @return  void
 */
#define UART1_CompareOn()       MemoryOr32(UART1_CTL,0x2)                   // UART1 compare irq on
/**
 * @brief This function sets UART1 compare irq off
 * 
 * @return  void
 */
#define UART1_CompareOff()      MemoryAnd32(UART1_CTL,~0x2)                 // UART1 compare irq off
/**
 * @brief This function sets UART1 compare value
 * 
 * @return  void
 */
#define UART1_SetCompare(val)   MemoryOr32(UART1_CTL,val<<8)                // set irq compare bits
#define UART1_ClearIrq()        MemoryWrite32(UART1_IRQ_ACK,0x0)            // clear irq
#define UART1_RaiseIrq()        MemoryOr32(UART1_CTL,0x1)                   // raise irq manually
/**
