...
#ifdef DEBUG
    printf("fp_float32_to_float64: a = 0x%lx\n",a);
    printf("fp_float32_to_float64: as = 0x%lx\n",as);
    printf("fp_float32_to_float64: ae = 0x%lx\n",ae);
    printf("fp_float32_to_float64: af = 0x%lx\n",af);
#endif
...
#ifdef DEBUG
    double float64 = a_fp;
    u_int32_t* ptr = (u_int32_t*)&float64;
    printf("Low 32 of double(2.0): 0x%x\n", ptr[0]);
    printf("High 32 of double(2.0): 0x%x\n", ptr[1]);
    printf("fp_float32_to_float64: lo = 0x%lx, it should be 0x%x\n", __float64_buffer_lo, ptr[0]);
    printf("fp_float32_to_float64: hi = 0x%lx, it should be 0x%x\n", __float64_buffer_hi, ptr[1]);
#endif
...
#ifdef DEBUG
    u_int32_t* ptr = (u_int32_t*)&a_dfp;
    printf("fp_float64_to_float32: lo = 0x%lx, it should be 0x%x\n", __float64_buffer_lo, ptr[0]);
    printf("fp_float64_to_float32: hi = 0x%lx, it should be 0x%x\n", __float64_buffer_hi, ptr[1]);
#endif
    as = __float32_sign__(__float64_buffer_hi);
    ae = __float32_expo_from_float64__(__float64_buffer_hi);

#ifdef DEBUG
    printf("fp_float64_to_float32: as = 0x%lx\n",as);
    printf("fp_float64_to_float32: ae = 0x%lx\n",ae);
#endif
...
#ifdef DEBUG
        printf("fp_float64_to_float32: af = 0x%lx\n",af);
#endif
        a = __assemble_float32__(as,ae,af);
        float a_fp = __uint32_to_float32__(a);
#ifdef DEBUG
        printf("fp_float64_to_float32: a_fp = %f, %lx\n", a_fp, __float32_to_uint32__(a_fp));
#endif
        return a_fp;
    }
}
